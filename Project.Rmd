...
The goal of this project is to predict the manner in which  exercises were  preformed using Weight Lifting Exercise Dataset. The data comes from acceleromteters placed on forearm, arm, belt and dumbell of six participants. They performed exercises correctly and incorrectly.
...
## Remove variables with NA values, taking threshold of 95%.
na_c <- sapply(trainingset, function(x) mean(is.na(x))) >0.95

trainingset <-trainingset[, na_c == FALSE]
testingset <- testingset[, na_c ==FALSE]
...
The accuracy of the Random Forest model is 99.59%
